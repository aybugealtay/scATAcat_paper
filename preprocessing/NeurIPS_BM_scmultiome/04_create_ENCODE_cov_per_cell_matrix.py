...
per_cell_encode_cCRE_map = pd.read_table("../../data/NeurIPS_BM_scmultiome/02_ENCODE_cCRE_coverage/NeurIPS_BM_scmultiome_s1d1_fragments_only_stdChr_ENCORE_cCRE_regions_.bed",delimiter="\t",header=None)
...
# expoer cCREs
pd.DataFrame(per_cell_encode_cCRE_map['region']).to_csv("../../data/NeurIPS_BM_scmultiome/04_ENCODE_coverage_by_cell_matrix/NeurIPS_BM_s1d1_ENCODE_cCREs.csv")
...
filtered_cell_list= pd.read_csv('../../data/NeurIPS_BM_scmultiome/03_cell_IDs/NeurIPS_BM_s1d1_cellIDs.csv/NeurIPS_BM_s1d1_cellIDs.csv',delimiter=",",header=0, index_col=0)
...
with open('../../data/NeurIPS_BM_scmultiome/04_ENCODE_coverage_by_cell_matrix/NeurIPS_BM_scmultiome_s1d1_per_cell_encode_cCRE_map.pkl', 'wb') as f:
...
# Saving the objects:
with open('../../data/NeurIPS_BM_scmultiome/04_ENCODE_coverage_by_cell_matrix/NeurIPS_BM_scmultiome_s1d1_per_cell_encode_cCRE_matrix.pkl', 'wb') as f:
...
with open('../../data/NeurIPS_BM_scmultiome/04_ENCODE_coverage_by_cell_matrix/NeurIPS_BM_scmultiome_s1d1_per_cell_encode_cCRE_matrix_sparse.pkl', 'wb') as f:
