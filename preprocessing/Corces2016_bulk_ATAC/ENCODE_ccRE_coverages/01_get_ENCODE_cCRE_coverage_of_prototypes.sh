...
do
  ...
  mkdir $DIR
  bedtools coverage -a /project/scATAC_analysis/10X_PBMC_analysis/AnnotationQuestion/overlap_bulk_and_scATAC/ENCODE_PBMC_cCRE/V2.hg38-cCREs-Final_sorted.bed -b $SRR.bed>  $DIR/${SRR}_NOTmerged_scATAC_overlap_ENCODE_cCRE_coverage.bed
