...
per_cell_encode_cCRE_map = pd.read_table("../../../data/Granja2019/PBMC_D10T1/02_ENCODE_cCRE_coverage/GSM4138893_scATAC_PBMC_D10T1_liftOverhg38_no_chrMt_sorted_ENCORE_cCRE_regions.bed",delimiter="\t",header=None)
...
# expoer cCREs
pd.DataFrame(per_cell_encode_cCRE_map['region']).to_csv("../../../data/Granja2019/PBMC_D10T1/02_ENCODE_cCRE_coverage/GSM4138893_scATAC_PBMC_D10T1_ENCODE_cCREs.csv")
...
filtered_cell_list= pd.read_csv('../../../data/Granja2019/PBMC_D10T1/03_cellIDs_and_annotations/cell_IDs.csv',delimiter=",",header=0)
...
with open('../../../data/Granja2019/PBMC_D10T1/02_ENCODE_cCRE_coverage/GSM4138893_scATAC_PBMC_D10T1_per_cell_encode_cCRE_map.pkl', 'wb') as f:
...
# Saving the objects:
with open('../../../data/Granja2019/PBMC_D10T1/04_ENCODE_coverage_by_cell_matrix/GSM4138893_scATAC_PBMC_D10T1_per_cell_encode_cCRE_matrix.pkl', 'wb') as f:
...
with open('../../../data/Granja2019/PBMC_D10T1/04_ENCODE_coverage_by_cell_matrix/GSM4138893_scATAC_PBMC_D10T1_per_cell_encode_cCRE_matrix_sparse.pkl', 'wb') as f:
